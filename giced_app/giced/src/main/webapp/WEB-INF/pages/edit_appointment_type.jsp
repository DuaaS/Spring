...
<c:url var="post_url"  value="/appointments/edit" />
...
class="form-horizontal" name="ApptForm" onsubmit="return validateform()">
	    <div class="row" >
	    		<div class="col-md-8 col-md-offset-1">
	      			<fieldset>
	      				<legend>Edit Appointment Type</legend>
				      	<div class="form-group">
				            <div class="col-sm-4">
				            	<form:label path="appointment_id">
				                    <spring:message text="Appointment Id"/>
				                </form:label>
				              	<form:input path="appointment_id" name="appointment_id" class="form-control" readonly="true"/>
				            </div>
			          	</div>
			          	<div class="form-group">
				            <div class="col-sm-4">
