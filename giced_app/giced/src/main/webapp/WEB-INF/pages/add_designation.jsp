...
<c:url var="post_url"  value="/designations/add" />
				      	...
				      	<div class="form-group">
				            <div class="col-sm-4">
				            	<form:label path="designation_id">
				                    <spring:message text="Designation Id"/><span class="required">*</span>
				                </form:label>
				              	<form:input path="designation_id" name="designation_id" class="form-control required"/>
				            </div>
			          	</div>
			          	<div class="form-group">
				            <div class="col-sm-4">
