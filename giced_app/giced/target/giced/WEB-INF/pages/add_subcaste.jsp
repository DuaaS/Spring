...
<title>Add New Sub-Caste</title>

<link href="<c:url value="/resources/core/css/bootstrap.min.css"/>" rel="stylesheet" />
    <script>
    function validateform(){  
		var subcaste_id=document.SubCasteForm.subcaste_id.value;  
		var subcaste_name=document.SubCasteForm.subcaste_name.value;  
		var caste_id=document.SubCasteForm.caste_id.value;  
		  
		if (subcaste_id==null || subcaste_id==""){  
		  alert("Sub-Caste Id can't be blank.");  
		  return false;  
		}
...
<c:url var="post_url"  value="/subcastes/add" />
...
<div class="col-md-8 col-md-offset-1">
	      			<fieldset>
	      				<legend>Add New Sub-Caste</legend>
				      	<div class="form-group">
				            <div class="col-sm-4">
				            	<form:label path="subcaste_id">
				                    <spring:message text="Sub-Caste Id"/><span class="required">*</span>
				                </form:label>
				              	<form:input path="subcaste_id" name="subcaste_id" class="form-control required"/>
				            </div>
			          	</div>
			          	<div class="form-group">
				            <div class="col-sm-4">
