...
<body>
<c:url var="post_url"  value="/faculties/edit" />
      ...
      <fieldset>
          ...
          <div class="form-group">
            <div class="col-sm-4">
			  ...
			  <form:input path="faculty_id" name="faculty_id" class="form-control" readonly="true"/>
            </div>
           </div>
            ...
            <div class="col-sm-2">
              ...
              <form:select  path="faculty_designation" name="faculty_designation" class="form-control">
            ...
            <div class="col-sm-2">
              ...
              <form:select path="faculty_abbreviation" class="form-control required" name="faculty_abbreviation">
						<form:option value="NONE" label="--- Select ---" />
          ...
          <div class="form-group">
              ...
              <form:input path="faculty_firstname" name="faculty_firstname" class="form-control required"/>
            </div>
            <div class="col-sm-4">
              <form:label path="faculty_middlename">
				 Middle Name
			  </form:label>
			  <form:input path="faculty_middlename" name="faculty_middlename" class="form-control"/>              
            </div>
            <div class="col-sm-4">
              <form:label path="faculty_lastname">
				 Last Name<span class="required">*</span>
			  </form:label>
              <form:input path="faculty_lastname" name="faculty_lastname" class="form-control required" />
            </div>            
          </div>
          ...
          <div class="form-group">
             ...
             <div class="col-sm-4">
			  ...
			  <form:input path="faculty_dob" name="faculty_dob" class="form-control required" id="date" type="text" value="${dob}"/>
            </div> 
          	<!-- Age-->
            <div class="col-sm-4">
              ...
              <form:input  path="faculty_age" name="faculty_age" class="form-control required" />
            </div> 
          </div>
          <!-- Gender-->  
         <div class="form-group">
          ...
          <div class="form-group">
	          ...
	          <div class="col-sm-4">
		            ...
		            <form:select  path="faculty_subcaste" name="faculty_subcaste" class="form-control required"  id="selectSubCaste" > 
					<form:option value="NONE" label="--- Select ---" />
						<c:forEach var="list" items="${listSubCaste}">
					       <form:option value="${list.subcaste_id}">${list.subcaste_name}</form:option> 
					   </c:forEach>
					</form:select>
	            </div>
	          <div class="col-sm-4">
          ...
          <div class="form-group">
           <div class="col-sm-10">
              ...
              <form:input path="faculty_building" name="faculty_building" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-10">
              ...
              <form:input path="faculty_street" name="faculty_street" class="form-control" />
            </div>
          </div>
          <div class="form-group">
          	<div class="col-sm-5">
            ...
            <div class="col-sm-5">
              ...
              <form:input path="faculty_station" name="faculty_station" class="form-control" />
            </div>
            <div class="col-sm-2">
              <form:label path="faculty_pincode">
				 Pincode
			  </form:label>
              <form:input path="faculty_pincode" name="faculty_pincode" class="form-control"/>
            </div>
          </div>
          <div class="form-group">
          	<div class="col-sm-5">
              ...
              <form:input path="faculty_city" name="faculty_city" class="form-control"/>
            </div>
            <div class="col-sm-5">
              <form:label path="faculty_state">
				 State
			  </form:label>
              <form:input path="faculty_state" name="faculty_state" class="form-control"/>
            </div>
          </div>
          <!-- Contact Numbers -->
          <div class="form-group">
              ...
              <form:input path="faculty_mobile" name="faculty_mobile" class="form-control required" />
            </div>
            <div class="col-sm-4">
              <form:label path="faculty_alt_mobile">
				 Alternate Mobile No.
			  </form:label>
              <form:input path="faculty_alt_mobile" name="faculty_alt_mobile" class="form-control"/>
            </div>
           	<div class="col-sm-4">
              <form:label path="faculty_telephone">
				 Telephone
			  </form:label>
              <form:input path="faculty_telephone" name="faculty_telephone" class="form-control required" />
            </div>
          </div>
          <!-- Email -->
          <div class="form-group">
              ...
              <form:input path="faculty_email" name="faculty_email" class="form-control required" />
            </div>
          	<div class="col-sm-5">
              <form:label path="faculty_alt_email">
				 Alternate Email<span class="required">*</span>
			  </form:label>
              <form:input path="faculty_alt_email" name="faculty_alt_email" class="form-control required" />
            </div>
          </div>
          ...
          <div class="form-group">
              ...
              <form:input path="faculty_pan" name="faculty_pan" class="form-control required" />
            </div>
          	<div class="col-sm-5">
              <form:label path="faculty_aadhar">
				 Aadhar No.<span class="required">*</span>
			  </form:label>
              <form:input path="faculty_aadhar" name="faculty_aadhar" class="form-control required"/>
            </div>
          </div>
		...
		<legend>Bank Details</legend>
          ...
          <div class="form-group">
              ...
              <form:input path="faculty_bank_name" name="faculty_bank_name" class="form-control required"/>
            </div>
          	<div class="col-sm-5">
              <form:label path="faculty_bank_branch">
				 Branch<span class="required">*</span>
			  </form:label>
              <form:input path="faculty_bank_branch" name="faculty_bank_branch" class="form-control required" />
            </div>
          </div>
          <div class="form-group">
          	<div class="col-sm-5">
              ...
              <form:input path="faculty_bank_account_no" name="faculty_bank_account_no" class="form-control required"/>
            </div>
          	<div class="col-sm-5">
              <form:label path="faculty_bank_ifsc">
				 Bank IFSC Code<span class="required">*</span>
			  </form:label>
              <form:input path="faculty_bank_ifsc" name="faculty_bank_ifsc" class="form-control required" />
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-sm-5">
              ...
              <form:input path="faculty_degree" name="faculty_degree" class="form-control required" />
            </div>
          	<div class="col-sm-5">
              <form:label path="faculty_specialization">
				 Specialization<span class="required">*</span>
			  </form:label>
              <form:input path="faculty_specialization" name="faculty_specialization" class="form-control required" />
            </div>
          </div>
          <!-- Masters -->
          <div class="form-group">
              ...
              <form:input path="faculty_masters" name="faculty_masters" class="form-control"/>
            </div>
          	<div class="col-sm-5">
              <form:label path="faculty_masters_specialization">
				 Masters Specialization
			  </form:label>
              <form:input path="faculty_masters_specialization" name="faculty_masters_specialization" class="form-control"/>
            </div>
          </div>
          <!-- PHD -->
          <div class="form-group">
              ...
              <form:input path="faculty_phd" name="faculty_phd" class="form-control"/>
            </div>
          	<!-- PHD Specialization -->
            <div class="col-sm-5">
              ...
              <form:input path="faculty_phd_specialization" name="faculty_phd_specialization" class="form-control" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              ...
              <form:input path="faculty_experience" name="faculty_experience" class="form-control required" />
            </div>
          	<!-- Experience Type -->
            <div class="col-sm-5">
              ...
              <form:select path="faculty_exp_type" class="form-control required" name="faculty_exp_type"  >
						<form:option value="NONE" label="--- Select ---" />
