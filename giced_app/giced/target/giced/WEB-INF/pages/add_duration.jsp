...
<title>Add New Course Duration</title>

<link href="<c:url value="/resources/core/css/bootstrap.min.css"/>" rel="stylesheet" />
    <script>
    function validateform(){  
		var duration_id=document.DurationForm.duration_id.value;  
		...
		if (duration_id==null || duration_id==""){  
		  alert("Duration Id can't be blank.");  
		  return false;  
		}
...
<c:url var="post_url"  value="/durations/add" />
...
class="form-horizontal" name="DurationForm" onsubmit="return validateform()" >
			<div class="row" >
	    		<div class="col-md-8 col-md-offset-1">
	      			<fieldset>
	      				<legend>Add New Course Duration</legend>
				      	<div class="form-group">
				            <div class="col-sm-4">
				            	<form:label path="duration_id">
				                    <spring:message text="Duration Id"/><span class="required">*</span>
				                </form:label>
				              	<form:input path="duration_id" name="duration_id" class="form-control required"/>
				            </div>
			          	</div>
			          	<div class="form-group">
				            <div class="col-sm-4">
			          	...
			          	<div class="form-group">
				            <div class="col-sm-4">
				            	<form:label path="duration_description">
				              	...
				              	<form:input path="duration_description" name="duration_description" class="form-control required"/>
				            </div>
			          	</div>
