...
<title>Add New Caste</title>

<link href="<c:url value="/resources/core/css/bootstrap.min.css"/>" rel="stylesheet" />
    <script>
    function validateform(){  
		var caste_id=document.CasteForm.caste_id.value;  
		var caste_name=document.CasteForm.caste_name.value;  
		
		if (caste_id==null || caste_id==""){  
		  alert("Caste Id can't be blank.");  
		  return false;  
		}
...
<c:url var="post_url"  value="/castes/add" />
...
class="form-horizontal" name="CasteForm" onsubmit="return validateform()" >
			<div class="row" >
	    		<div class="col-md-8 col-md-offset-1">
	      			<fieldset>
	      				<legend>Add New Caste</legend>
				      	<div class="form-group">
				            <div class="col-sm-4">
				            	<form:label path="caste_id">
				                    <spring:message text="Caste Id"/><span class="required">*</span>
				                </form:label>
				              	<form:input path="caste_id" name="caste_id" class="form-control required"/>
				            </div>
			          	</div>
			          	<div class="form-group">
				            <div class="col-sm-4">
