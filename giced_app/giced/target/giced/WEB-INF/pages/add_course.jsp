...
<link href="<c:url value="/resources/core/css/bootstrap.min.css"/>" rel="stylesheet" />
    ...
    function validateform(){  
		...
		var course_id=document.CourseForm.course_id.value;
...
<c:url var="post_url"  value="/courses/add" />
				      	...
				      	<div class="form-group">
				            <div class="col-sm-4">
				            	<form:label path="course_id">
				                    <spring:message text="Course Id"/><span class="required">*</span>
				                </form:label>
				              	<form:input path="course_id" name="course_id" class="form-control required"/>
				            </div>
			          	</div>
			          	<div class="form-group">
				            <div class="col-sm-4">
